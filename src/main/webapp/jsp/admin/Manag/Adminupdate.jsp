    ...
    <script>
        $(document).ready(function() {
            ...
            $("#updatebase").click(function () {  //点击登录按钮
                ...
                if (status==true) {
                    $.post("<%=basePath%>admin/goupdateubase", $("#baseupdateform").serialize(), function (data) {
                        if(data.massage==1){
                            alert("修改成功！");
                            location.href = "<%=basePath%>admin/AdminShow?index=0";
                        }else{
                            alert("用户名已存在，请重新输入！");
                        }
        ...
        $("#clearIconPath").click(function() {
            ...
            $('#admin_head1').attr("src", "${getAdmin.admin_head}");
        });
...
<div class="ane">
    ...
    <div class="formbody">
        ...
        <form id="baseupdateform" method="post">
            <ul class="forminfo">
                <li><label>*头像</label>
                <li> <img  id="admin_head1" style="margin-left: 90px" border="1"  width="180px"  height="180px" src="${getAdmin.admin_head}">
                ...
                <input id="admin_head" name="admin_head" type="text" class="dfinput" value="${getAdmin.admin_head}" readonly="readonly" style="display:none" />
                <li><label>*昵称</label><input name="admin_nickname" id="admin_nickname" type="text" class="dfinput" value="${getAdmin.admin_nickname}" /></li>
                <li><label>*手机号</label><input name="admin_phone"id="admin_phone" type="text" class="dfinput" value="${getAdmin.admin_phone}"/></li>

                <li><label>*邮箱</label><input name="admin_Email" id="admin_Email" type="email" class="dfinput" value="${getAdmin.admin_Email}"/></li>
